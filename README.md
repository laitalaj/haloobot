...
2. Install telepot, dataset, gtts and emoji with pip and mpg123 and vorbis-tools with a package manager of your choice (or by some other method, as long as they can be used from command line)
